...
const protectedPrefixes = ["/prenota", "/le-mie-prenotazioni", "/comunicazioni", "/profilo"];
...
export const config = {
  matcher: ["/prenota/:path*", "/le-mie-prenotazioni/:path*", "/comunicazioni/:path*", "/profilo/:path*", "/admin/:path*"],
};
